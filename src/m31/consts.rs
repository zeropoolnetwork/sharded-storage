...
// Computed at https://github.com/zeropoolnetwork/sharded-storage/blob/main/primitives/examples/gen_seedboxes.rs

pub const POSEIDON2_W16_D5_ROUNDS_F: usize = 8;
pub const POSEIDON2_W16_D5_ROUNDS_P: usize = 14;
pub const POSEIDON2_W16_D5_EXTERNAL_CONSTANTS: [[Mersenne31; 16]; 8] = [
...
pub const POSEIDON2_W16_D5_INTERNAL_CONSTANTS: [Mersenne31; 14] = [
